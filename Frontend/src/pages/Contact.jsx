...
const ContactMe = () => {
  return (
    <div className="bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 py-7 px-4 sm:px-6 lg:px-8">
      <motion.div
      ...
      >
        ...
        >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 font-bold">
            ...
            <a
              href="https://drive.google.com/file/d/1P63OlJTf7l2k4gZkbFaeWLx1GNLiHlzS/view?usp=sharing"
              target="_blank"
              rel="noopener noreferrer"
              className="bg-blue-600 text-white px-4 py-2 rounded-lg shadow hover:bg-blue-700 transition text-center"
            >
